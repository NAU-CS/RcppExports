...
RcppExport SEXP _CVR_cvrsolver(SEXP YSEXP, SEXP XlistSEXP, SEXP rankSEXP, SEXP etaSEXP, SEXP LamSEXP, SEXP familySEXP, SEXP WiniSEXP, SEXP penaltySEXP, SEXP optsSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_CVR_cvrsolver", (DL_FUNC) &_CVR_cvrsolver, 9},
    {NULL, NULL, 0}
};
