...
RcppExport SEXP _AhoCorasickTrie_AhoCorasickSearchList(SEXP keywordsSEXP, SEXP textListSEXP, SEXP alphabetSEXP, SEXP groupByKeywordSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(AhoCorasickSearchList(keywords, textList, alphabet, groupByKeyword));
...
RcppExport SEXP _AhoCorasickTrie_AhoCorasickSearch(SEXP keywordsSEXP, SEXP textSEXP, SEXP alphabetSEXP, SEXP groupByKeywordSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::StringVector >::type keywords(keywordsSEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type alphabet(alphabetSEXP);
    Rcpp::traits::input_parameter< bool >::type groupByKeyword(groupByKeywordSEXP);
    rcpp_result_gen = Rcpp::wrap(AhoCorasickSearch(keywords, text, alphabet, groupByKeyword));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_AhoCorasickTrie_AhoCorasickSearchList", (DL_FUNC) &_AhoCorasickTrie_AhoCorasickSearchList, 4},
    {"_AhoCorasickTrie_AhoCorasickSearch", (DL_FUNC) &_AhoCorasickTrie_AhoCorasickSearch, 4},
    {NULL, NULL, 0}
};
