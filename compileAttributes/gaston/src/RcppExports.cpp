...
// AIREML1_logit_nofix
List AIREML1_logit_nofix(NumericVector Y, NumericMatrix K_, bool constraint, double min_tau, int max_iter, double eps, bool verbose, double tau0, bool start_tau, bool get_P);
RcppExport SEXP _gaston_AIREML1_logit_nofix(SEXP YSEXP, SEXP K_SEXP, SEXP constraintSEXP, SEXP min_tauSEXP, SEXP max_iterSEXP, SEXP epsSEXP, SEXP verboseSEXP, SEXP tau0SEXP, SEXP start_tauSEXP, SEXP get_PSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type get_P(get_PSEXP);
    rcpp_result_gen = Rcpp::wrap(AIREML1_logit_nofix(Y, K_, constraint, min_tau, max_iter, eps, verbose, tau0, start_tau, get_P));
    return rcpp_result_gen;
END_RCPP
}
// AIREML1_logit
List AIREML1_logit(NumericVector Y, NumericMatrix X, NumericMatrix K_, bool constraint, double min_tau, int max_iter, double eps, bool verbose, double tau0, NumericVector beta0, bool start_tau, bool start_beta, bool get_P);
RcppExport SEXP _gaston_AIREML1_logit(SEXP YSEXP, SEXP XSEXP, SEXP K_SEXP, SEXP constraintSEXP, SEXP min_tauSEXP, SEXP max_iterSEXP, SEXP epsSEXP, SEXP verboseSEXP, SEXP tau0SEXP, SEXP beta0SEXP, SEXP start_tauSEXP, SEXP start_betaSEXP, SEXP get_PSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type get_P(get_PSEXP);
    rcpp_result_gen = Rcpp::wrap(AIREML1_logit(Y, X, K_, constraint, min_tau, max_iter, eps, verbose, tau0, beta0, start_tau, start_beta, get_P));
    return rcpp_result_gen;
END_RCPP
}
// AIREMLn_logit_nofix
List AIREMLn_logit_nofix(NumericVector Y, List K_, bool constraint, NumericVector min_tau_, int max_iter, double eps, bool verbose, NumericVector tau0, bool start_tau, bool get_P);
RcppExport SEXP _gaston_AIREMLn_logit_nofix(SEXP YSEXP, SEXP K_SEXP, SEXP constraintSEXP, SEXP min_tau_SEXP, SEXP max_iterSEXP, SEXP epsSEXP, SEXP verboseSEXP, SEXP tau0SEXP, SEXP start_tauSEXP, SEXP get_PSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type start_tau(start_tauSEXP);
    Rcpp::traits::input_parameter< bool >::type get_P(get_PSEXP);
    rcpp_result_gen = Rcpp::wrap(AIREMLn_logit_nofix(Y, K_, constraint, min_tau_, max_iter, eps, verbose, tau0, start_tau, get_P));
    return rcpp_result_gen;
END_RCPP
}
// AIREMLn_nofix
...
// GWAS_logitmm_wald
List GWAS_logitmm_wald(XPtr<matrix4> pA, NumericVector mu, NumericVector Y, NumericMatrix X, NumericMatrix K, int beg, int end, double tol);
RcppExport SEXP _gaston_GWAS_logitmm_wald(SEXP pASEXP, SEXP muSEXP, SEXP YSEXP, SEXP XSEXP, SEXP KSEXP, SEXP begSEXP, SEXP endSEXP, SEXP tolSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< XPtr<matrix4> >::type pA(pASEXP);
...
// gg_pre_likelihood_nofix
double gg_pre_likelihood_nofix(NumericVector Y, List K_, NumericVector h2);
RcppExport SEXP _gaston_gg_pre_likelihood_nofix(SEXP YSEXP, SEXP K_SEXP, SEXP h2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type Y(YSEXP);
...
// gg_re_likelihood_nofix
double gg_re_likelihood_nofix(NumericVector Y, List K_, NumericVector theta);
RcppExport SEXP _gaston_gg_re_likelihood_nofix(SEXP YSEXP, SEXP K_SEXP, SEXP thetaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type Y(YSEXP);
