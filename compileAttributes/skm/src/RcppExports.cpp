...
RcppExport SEXP _skm_dist_wlatlng_mi_cpp(SEXP lat1SEXP, SEXP lng1SEXP, SEXP lat2SEXP, SEXP lng2SEXP) {
BEGIN_RCPP
...
RcppExport SEXP _skm_dist_wlatlng_km_cpp(SEXP lat1SEXP, SEXP lng1SEXP, SEXP lat2SEXP, SEXP lng2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type lat1(lat1SEXP);
...
RcppExport SEXP _skm_distSgl_wlatlng_cpp(SEXP lat1SEXP, SEXP lng1SEXP, SEXP lat2SEXP, SEXP lng2SEXP, SEXP measureSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _skm_distRpl_wlatlng_cpp(SEXP lat1SEXP, SEXP lng1SEXP, SEXP lat2SEXP, SEXP lng2SEXP, SEXP measureSEXP, SEXP distRpl_GSSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _skm_col_min_idx(SEXP uSEXP, SEXP wlmtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _skm_col_max_idx(SEXP uSEXP, SEXP wlmtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type u(uSEXP);
...
RcppExport SEXP _skm_col_min_val(SEXP uSEXP, SEXP wlmtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type u(uSEXP);
...
RcppExport SEXP _skm_col_max_val(SEXP uSEXP, SEXP wlmtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type u(uSEXP);
...
RcppExport SEXP _skm_col_rgn_val(SEXP uSEXP, SEXP wlmtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type u(uSEXP);
...
RcppExport SEXP _skm_stratified_sampling(SEXP vSEXP, SEXP kSEXP, SEXP gSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _skm_skm_mlp_cpp(SEXP xSEXP, SEXP kSEXP, SEXP s_mustSEXP, SEXP max_itSEXP, SEXP max_atSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _skm_skm_mls_cpp(SEXP xSEXP, SEXP kSEXP, SEXP gSEXP, SEXP s_mustSEXP, SEXP max_itSEXP, SEXP max_atSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type x(xSEXP);
...
RcppExport SEXP _skm_skmRpl_mlp_cpp(SEXP xSEXP, SEXP kSEXP, SEXP s_mustSEXP, SEXP max_itSEXP, SEXP max_atSEXP, SEXP skmRpl_GSSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _skm_skm_gdp_cpp(SEXP xSEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _rcpp_module_boot_skm_module();

static const R_CallMethodDef CallEntries[] = {
    {"_skm_dist_wlatlng_mi_cpp", (DL_FUNC) &_skm_dist_wlatlng_mi_cpp, 4},
    {"_skm_dist_wlatlng_km_cpp", (DL_FUNC) &_skm_dist_wlatlng_km_cpp, 4},
    {"_skm_distSgl_wlatlng_cpp", (DL_FUNC) &_skm_distSgl_wlatlng_cpp, 5},
    {"_skm_distRpl_wlatlng_cpp", (DL_FUNC) &_skm_distRpl_wlatlng_cpp, 6},
    {"_skm_col_min_idx", (DL_FUNC) &_skm_col_min_idx, 2},
    {"_skm_col_max_idx", (DL_FUNC) &_skm_col_max_idx, 2},
    {"_skm_col_min_val", (DL_FUNC) &_skm_col_min_val, 2},
    {"_skm_col_max_val", (DL_FUNC) &_skm_col_max_val, 2},
    {"_skm_col_rgn_val", (DL_FUNC) &_skm_col_rgn_val, 2},
    {"_skm_stratified_sampling", (DL_FUNC) &_skm_stratified_sampling, 3},
    {"_skm_skm_mlp_cpp", (DL_FUNC) &_skm_skm_mlp_cpp, 5},
    {"_skm_skm_mls_cpp", (DL_FUNC) &_skm_skm_mls_cpp, 6},
    {"_skm_skmRpl_mlp_cpp", (DL_FUNC) &_skm_skmRpl_mlp_cpp, 6},
    {"_skm_skm_gdp_cpp", (DL_FUNC) &_skm_skm_gdp_cpp, 2},
    {"_rcpp_module_boot_skm_module", (DL_FUNC) &_rcpp_module_boot_skm_module, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_skm(DllInfo *dll) {
