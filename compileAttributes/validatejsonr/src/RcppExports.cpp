...
RcppExport SEXP _validatejsonr_validate_jsonfile_with_schemafile(SEXP jsonfnSEXP, SEXP schemafnSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _validatejsonr_validate_json_with_schemafile(SEXP json_stringSEXP, SEXP schemafnSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _validatejsonr_validate_jsonfile_with_schema(SEXP jsonfnSEXP, SEXP schema_stringSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type jsonfn(jsonfnSEXP);
...
RcppExport SEXP _validatejsonr_validate_json_with_schema(SEXP json_stringSEXP, SEXP schema_stringSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type json_string(json_stringSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_validatejsonr_validate_jsonfile_with_schemafile", (DL_FUNC) &_validatejsonr_validate_jsonfile_with_schemafile, 2},
    {"_validatejsonr_validate_json_with_schemafile", (DL_FUNC) &_validatejsonr_validate_json_with_schemafile, 2},
    {"_validatejsonr_validate_jsonfile_with_schema", (DL_FUNC) &_validatejsonr_validate_jsonfile_with_schema, 2},
    {"_validatejsonr_validate_json_with_schema", (DL_FUNC) &_validatejsonr_validate_json_with_schema, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_validatejsonr(DllInfo *dll) {
