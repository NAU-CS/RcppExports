...
// InforCriteria
double InforCriteria(double SSE, double nY, int p, int n, string criteria, double sigma, double SST);
RcppExport SEXP _StepReg_InforCriteria(SEXP SSESEXP, SEXP nYSEXP, SEXP pSEXP, SEXP nSEXP, SEXP criteriaSEXP, SEXP sigmaSEXP, SEXP SSTSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type SSE(SSESEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(InforCriteria(SSE, nY, p, n, criteria, sigma, SST));
...
static const R_CallMethodDef CallEntries[] = {
    {"_StepReg_InforCriteria", (DL_FUNC) &_StepReg_InforCriteria, 7},
