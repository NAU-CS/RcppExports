...
RcppExport SEXP _miRNAss_calcDistance(SEXP pSEXP, SEXP idxSEXP, SEXP xSEXP, SEXP ySEXP) {
BEGIN_RCPP
...
RcppExport SEXP _miRNAss_calcThreshold(SEXP yeSEXP, SEXP ytSEXP, SEXP objectiveSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _miRNAss_edgeListKnn(SEXP xSEXP, SEXP ySEXP, SEXP nnSEXP, SEXP threadNumberSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
